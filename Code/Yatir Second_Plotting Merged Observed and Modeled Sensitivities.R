...
ModeledResponse<-ModeledResponse%>%mutate(RelativePredictedPAR=PredictedPAR/max(PredictedPAR,na.rm=T))
ObservedResponse<-ObservedResponse%>%mutate(RelativePredictedPAR=PredictedPAR/max(PredictedPAR,na.rm=T))
